        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_TicketCategories_SlaHours", "\"DefaultSlaHours\" > 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_KnowledgeArticles_TicketCategories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_SupportAgentSkills_Level", "\"ProficiencyLevel\" BETWEEN 1 AND 5");
                    table.ForeignKey(
                        name: "FK_SupportAgentSkills_TicketCategories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "TicketCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SupportAgentSkills_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Tickets_Priority", "\"Priority\" BETWEEN 0 AND 3");
                    table.CheckConstraint("CK_Tickets_Status", "\"Status\" BETWEEN 0 AND 7");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "integer", nullable: false),
                    CurrentStep = table.Column<string>(type: "character varying(60)", maxLength: 60, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AgentWorkflows_Tickets_TicketId",
                        column: x => x.TicketId,
                        principalTable: "Tickets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AgentWorkflows_Users_StartedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TicketArticleLinks_KnowledgeArticles_ArticleId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AgentName = table.Column<string>(type: "character varying(60)", maxLength: 60, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProposedActionJson = table.Column<string>(type: "jsonb", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_AiApprovals_Status", "\"Status\" BETWEEN 0 AND 3");
                    table.ForeignKey(
                        name: "FK_AiApprovals_AgentWorkflows_WorkflowId",
                        column: x => x.WorkflowId,
                        principalTable: "AgentWorkflows",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AiApprovals_Tickets_TicketId",
                        column: x => x.TicketId,
                        principalTable: "Tickets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AiApprovals_Users_DecidedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ToolName = table.Column<string>(type: "character varying(60)", maxLength: 60, nullable: false),
                    InputJson = table.Column<string>(type: "jsonb", nullable: true),
                    OutputJson = table.Column<string>(type: "jsonb", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_AgentToolCalls_AgentWorkflows_WorkflowId",
                        column: x => x.WorkflowId,
                        principalTable: "AgentWorkflows",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AgentSteps_WorkflowId_StepOrder",
                table: "AgentSteps",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AgentToolCalls_WorkflowId",
                table: "AgentToolCalls",
                column: "WorkflowId");

            migrationBuilder.CreateIndex(
                name: "IX_AgentWorkflows_StartedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AgentWorkflows_TicketId",
                table: "AgentWorkflows",
                column: "TicketId");

            migrationBuilder.CreateIndex(
                name: "IX_AiApprovals_DecidedByUserId",
                table: "AiApprovals",
                column: "DecidedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_AiApprovals_Status",
                table: "AiApprovals",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_AiApprovals_TicketId",
                table: "AiApprovals",
                column: "TicketId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupportAgentSkills_CategoryId",
                table: "SupportAgentSkills",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_SupportAgentSkills_UserId_CategoryId",
                table: "SupportAgentSkills",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketArticleLinks_TicketId_ArticleId",
                table: "TicketArticleLinks",
                columns: new[] { "TicketId", "ArticleId" },
                unique: true);
